            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('auth.register.create') }}">
                        ...
                        <div class="form-group row">
                            <label for="code" class="col-md-4 col-form-label text-md-right">Код контрагента <br> (если есть)</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" pattern="8[0-9]{10}" placeholder="89040000000" type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="tel">
